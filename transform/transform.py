...
def transform_actual_load_n_days_prior(root, expected_date, tz_str='Europe/Paris'):
    load_values = []
...
def transform_forecast_load_n_days_prior(root, expected_date, tz_str='Europe/Paris'):
    load_values = []
    local_tz = ZoneInfo(tz_str)
